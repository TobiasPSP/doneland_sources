...
Regardless of whether you plan to write firmware or use pre-made firmware, the first step is to [connect your microcontroller board to your PC](https://done.land/components/microcontroller/firststeps/connecttopc/#connecting-to-computer) via USB. Verify that your PC recognizes the board.
...
For more options, explore [additional pre-made firmware](https://done.land/components/microcontroller/firmware/fromsomeoneelse/).
...
If you have programming skills or sample code, you can use a [development environment to compile the source code](https://done.land/components/microcontroller/firmware/writingownfirmware/) into firmware. Once compiled, the firmware can be uploaded to your microcontroller.
...
[Visit Page on Website](https://done.land/components/microcontroller/firststeps?343890051021241839) - created 2024-05-20 - last edited 2024-12-15
