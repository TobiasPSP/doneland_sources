...
2. Identify the board you are using in the table:
    ...
    |-------------|----------------------|-------------|----------------|---------|---------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
    | **esp32dev_OLED** | [ESP32S](https://done.land/components/microcontroller/families/esp/esp32/classicesp32/) | OLED 0.96/1.3" 128x64 | [SH1106](https://done.land/components/humaninterface/display/oled/sh1106/) | 21 | 22 | 0.96"/1.3" I2C OLED displays |
    ...
    | **ttgo-t7-WEACT_GDEH0154D67** | [ESP32S](https://done.land/components/microcontroller/families/esp/esp32/classicesp32/) | e-Ink 1.54" 200x200 | GDEH0154D67 | 21 | 22 | *WeAct Studio e-Ink display GDEH0154D67* |
