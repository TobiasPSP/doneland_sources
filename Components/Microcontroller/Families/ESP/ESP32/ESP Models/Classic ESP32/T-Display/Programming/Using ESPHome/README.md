...
> [!TIP]
> You may also want to check out the [second part of this article](https://done.land/components/microcontroller/families/esp/esp32/classicesp32/t-display/programming/usingesphome/addingdeepsleep/) where the configuration is using the new [ILI9xxx TFT LCD Series](https://esphome.io/components/display/ili9xxx#ili9xxx) component and is optimized for *battery use* and *low power consumption*.
...
[Visit Page on Website](https://done.land/components/microcontroller/families/esp/esp32/espmodels/classicesp32/t-display/programming/usingesphome?856302101504243514) - created 2024-10-03 - last edited 2024-10-17
