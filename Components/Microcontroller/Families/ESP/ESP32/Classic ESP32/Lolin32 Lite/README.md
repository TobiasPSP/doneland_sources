...
To reduze the board size, it has a *reset* but no *boot* button. This is not a problem as the board reliably automatically turns to *firmware upload mode* in *Arduino IDE*, *platform.io*, and *ESPHome*.
