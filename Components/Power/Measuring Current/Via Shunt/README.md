...
* **0.02 Ohm:** To measure a maximum current of **5A** and get a voltage drop of *100mV* at this current, the *shunt* resistance is *U = R * I*, *R = U / I*, thus *0.1V / 5A = 0.02 Ohm*. The maximum *power* passing through the *shunt* would be *5A * 
