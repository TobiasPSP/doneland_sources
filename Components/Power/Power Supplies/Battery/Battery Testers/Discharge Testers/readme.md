...
*Discharge only* testers cannot *charge* a battery. They rely on *you* to first charge the battery under test *before* you start testing. Compared with [all-in-one testers](https://done.land/components/power/powersupplies/battery/batterytesters/all-in-onetesters), they do come with  *voltage and current logging* and a *test load* but lack *charging capabilities*.
...
[Visit Page on Website](https://done.land/components/power/powersupplies/battery/batterytesters/dischargetesters?643318111410241653) - created 2024-11-09 - last edited 2025-01-15
